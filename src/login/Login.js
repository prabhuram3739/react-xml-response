...
<div id="ROOT-2521314" className="v-app nokia mavocenterui">
    ...
    <div className="flex layout vertical center-justified">
        <div className="login-fields-input">
            ...
            <div location="password_field"><div className="v-captionwrapper"><div className="v-caption v-caption-inline-icon" id="gwt-uid-5" for="gwt-uid-6"><span className="v-icon IcoMoon-Lindua"></span><div className="v-captiontext">Password</div></div><input type="password" className="v-textfield v-widget inline-icon v-textfield-inline-icon" id="gwt-uid-6" aria-labelledby="gwt-uid-5" tabindex="0" /></div></div>
