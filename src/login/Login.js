...
<div id="ROOT-2521314" className="v-app nokia mavocenterui">
    ...
    <div location="user_name_field"><div className="v-captionwrapper"><div className="v-caption v-caption-inline-icon" id="gwt-uid-3" for="gwt-uid-4"><FontAwesomeIcon icon = { faUser } className="v-icon marginTopClass ml-3" /><div className="v-captiontext">E-mail</div></div><input type="text" className="v-textfield v-widget inline-icon v-textfield-inline-icon" id="gwt-uid-4" aria-labelledby="gwt-uid-3" tabindex="0"  /></div></div>
            <div location="password_field"><div className="v-captionwrapper"><div className="v-caption v-caption-inline-icon" id="gwt-uid-5" for="gwt-uid-6"><FontAwesomeIcon icon = { faLock } className="v-icon marginTopClass ml-3" /><div className="v-captiontext">Password</div></div><input type="password" className="v-textfield v-widget inline-icon v-textfield-inline-icon" id="gwt-uid-6" aria-labelledby="gwt-uid-5" tabindex="0" /></div></div>
